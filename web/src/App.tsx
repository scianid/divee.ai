...
{`<script src="https://cdn.prismai.com/widget.js"
        ...
        <section id="pricing" className="section">
          <div className="container">
            <Reveal as="h2" className="sectionTitle" delay={0}>
              Free features in every plan
            </Reveal>
            <Reveal as="p" className="sectionLead" delay={80}>
              Everything you need to launch quickly—and look great doing it.
            </Reveal>
            ...
            <div className="listGrid">
              {[
                ...
                <Reveal key={item} className="listItem" delay={120 + idx * 45}>
                  {item}
                </Reveal>
              ))}
            </div>
        ...
        <section id="demo" className="section sectionAlt">
          <div className="container">
            ...
            <Reveal as="p" className="sectionLead" delay={80}>
              Try the interactive demo or watch a short walkthrough.
            </Reveal>
            ...
            <Reveal className="demoActions" delay={140}>
              ...
              <a className="btn btnSecondary" href="#cta" aria-label="Watch demo video">
                <PlayIcon style={{ marginRight: 10, opacity: 0.85 }} />
                Watch demo video
              </a>
            </Reveal>
          </div>
        ...
        <section id="faq" className="section">
          <div className="container">
            ...
            <div className="faq">
              {faqs.map((f, idx) => (
                <Reveal key={f.q} className="faqItem" delay={90 + idx * 60}>
